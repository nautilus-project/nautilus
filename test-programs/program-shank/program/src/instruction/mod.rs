...
pub enum MyInstruction {
    ...
    #[account(2, signer, name = "authority", desc = "Record authority")]
    ...
    #[account(1, signer, name = "authority", desc = "Record authority")]
    ...
    #[account(1, name = "system_program", desc = "The System Program")]
    Custom3(CustomEnumType),
}

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug)]
pub enum CustomEnumType {
    Joe(CustomEnumArgs),
    JoeC(String),
}

#[derive(BorshDeserialize, BorshSerialize, Clone, Debug)]
pub struct CustomEnumArgs {
    joe: String,
}
