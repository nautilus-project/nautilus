pub struct AssociatedToken<'a> {
    account_info: solana_program::account_info::AccountInfo<'a>,
}

impl<'a> From<solana_program::account_info::AccountInfo<'a>> for AssociatedToken<'a> {
...
impl<'a> solana_program::account_info::IntoAccountInfo<'a> for AssociatedToken<'a> {
    fn into_account_info(self) -> solana_program::account_info::AccountInfo<'a> {
        self.account_info
    }
}

impl<'a> crate::NautilusAccountInfo<'a> for AssociatedToken<'a> {
...
impl<'a> AssociatedToken<'a> {
    pub fn create<T: crate::NautilusAccountInfo<'a>>(mint: super::Mint, owner: T) -> Self {
        todo!()
    }
